...
namespace Bookify.Application.UnitTests.Bookings
{
	public class ReserveBookingTests
	{
		...
		private static readonly ReserveBookingCommand Command = new ReserveBookingCommand(
			Guid.NewGuid(),
			Guid.NewGuid(),
		...
		private readonly IUnitOfWork _unitOfWorksMock;
		private readonly PricingService _pricingService;
		public readonly IDateTimeProvider _dateTimeProviderMock;
		...
		public ReserveBookingTests()
		{
			...
			_unitOfWorksMock = Substitute.For<IUnitOfWork>();
		...
		public async Task Handle_Should_CallRepository_WhenBookingIsReserved()
		{
			...
			// Assert
			_bookingRepositoryMock.Received(1)
